        ...
        >
          ...
          <div className='flex items-start justify-between gap-4 pb-5 border-b border-border/70 shrink-0'>
            <div className='flex items-start gap-3.5 sm:gap-4 min-w-0'>
              <div
                className={`shrink-0 size-14 rounded-full border flex items-center justify-center font-mono text-sm font-bold tracking-tight select-none shadow-2xs mt-0.5 ${project.logoStyle}`}
              >
                {project.logoText && (
                  <Image
                    alt={project.title}
